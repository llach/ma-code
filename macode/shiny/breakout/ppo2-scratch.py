...
models_dir = f'{home}/.forkan/done/breakout/ppo2-scratch'

for fi, name in [('rlc1', 'kappa=1'), ('rlc10', 'kappa=10')]:
...
plt.savefig(f'{home}/.forkan/done/breakout/ppo2-scratch/kappa-nostop.png')
plt.show()
